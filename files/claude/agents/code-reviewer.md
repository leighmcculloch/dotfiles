---
name: code-reviewer
description: "Use this agent when you need to review code changes, whether they are uncommitted changes in the working directory, specific commits, branch diffs, or GitHub pull requests."
model: opus
color: cyan
---
