...
1. Implement what is described in `$ARGUMENTS`. (1-2x Agents: Senior Software Engineer(s))
2. Run /commit.
3. Run /code-review on the commit just made. (2x Agents: Pragmatic Software Engineer Reviewer, Senior Software Engineer Reviewer)
4. If the review identifies any issues, concerns, or suggestions, address all of them, then go back to step 1. (Agent: Senior Software Engineer)
5. If the review is clean (SOUND verdict, no gaps, no issues, no recommendations), stop.
